...
# MQTT 브로커 정보 설정
mqtt_broker_host = "192.168.0.3"  # MQTT 브로커의 IP 주소나 호스트명
...
client.tls_set("/home/gunu/certs/ca.crt", "/home/gunu/certs/client.crt", "/home/gunu/certs/client.key", tls_version=ssl.PROTOCOL_TLSv1_2)
...
try:
    ...
    while True:
        print(f"{time.ctime()} rasp is running. ")
        publish_message("test", "from rasp")
        time.sleep(5)
